...
import org.example.sweater.domain.dto.CapthcaResponseDto;
...
public class RegisrtationController {
    ...
    public String addUser(
            ...
            @RequestParam("g-recaptcha-response") String capthcaResponse,
            @Valid User user,
            BindingResult bindingResult, Model model
    ) {
        String url = String.format(CAPTHCA_URL, secret, capthcaResponse);
